...
\definecolor{blue3}{HTML}{D1FCFE}
\definecolor{blue4}{RGB}{72, 141, 246}
\definecolor{blue5}{HTML}{F0FEFF}
\definecolor{blue6}{RGB}{20, 230, 253}
\definecolor{blue7}{RGB}{207, 225, 235}
...
\NewDocumentEnvironment{intrormk}{O{Contributor} +b}{
    ...
    {\textbf{{\centering\rmfamily Introduction}}}\newline #2}{}
}{\iftoggle{showremark}{\end{tcolorbox}}{}}
...
\fancyhead[L]{Some Notes about Real Analysis}
\fancyhead[R]{MATH3611-01}
\fancyfoot[C]{Page.\thepage}

\title{{\huge 实分析} \\ Real Analysis}
